...
//v1.9 - Moved counting to a single place to prevent ISR's stepping on one-another
...
const char releaseNumber[4] = "1.9";                  // Displays the release on the menu 
...
void setup()                                        // Note: Disconnected Setup()
{
  ...
  */
  ...
  pinMode(intPin1,INPUT);                           // pressure sensor interrupt #1
  pinMode(intPin2,INPUT);                           // Pressure sensor interrupt #2
